<?php
class ControllerExtensionModuleBlockDiscount extends Controller {
	public function index($setting) {
    $this->load->language('extension/module/block_discount');
      ...
      foreach ($results as $result) {
        ...
        $data['products'][] = array(
          ...
          'hasOptions'  => $hasOptions
			...
			return $this->load->view('extension/module/block_discount', $data);
		}
	}
}
