...
$_['text_notify_in_stock']  = 'Сообщить о поступлении';
$_['text_call_us_about_product'] = 'Если вас заинтересовал этот товар, позвоните или напишите нам, мы привезём его под заказ.';
