...
$_['text_notInStock'] = 'Эти товары закончились,';
$_['text_notInStock_info'] = 'чтобы оформить покупку перенесите их в избранное (и мы вам сообщим о новом поступлении), либо удалите.';
$_['text_ship'] = 'Доставка';
$_['text_payment_title'] = 'Оплата';

$_['text_voucher_added'] = 'Сертификат добавлен';