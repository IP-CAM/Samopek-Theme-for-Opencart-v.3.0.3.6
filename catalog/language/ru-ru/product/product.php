...
$_['text_year']                = 'год';
$_['text_sku'] = 'Артикул:';
//$_['text_delivery_info'] = 'Самовывоз сегодня | Бесплатно<br>Курьер завтра | 250 ₽<br>СДЭК 3–5 дней | от 500 ₽';
$_['text_delivery_info'] = 'Самовывоз (Н.Новгород)| Бесплатно<br>Курьер сегодня(Н.Новгород)| 250 ₽<br>СДЭК (по России)| от 500 ₽';
$_['text_delivery'] = 'Доставка';
$_['text_price'] = 'Стоимость';
$_['text_qty'] = 'Количество';
$_['text_description'] = 'Описание';
$_['text_brands'] = 'Все товары бренда';
...
$_['text_max_incart'] = 'В вашей корзине уже лежит максимальное количество данного товара, которое есть у нас в наличии.';
$_['text_max'] = 'Максимум';