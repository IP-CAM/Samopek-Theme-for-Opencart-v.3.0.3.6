...
class samopek_ControllerProductProduct extends ControllerProductProduct
{
  	public function index() {
        ...
        foreach ($cartlist as $one) {
            ...
            if ($product_info['product_id'] == $one['product_id']) $data['inCart'] = true;
        }
        ...
        $data['in_wishlist'] = in_array($product_info['product_id'], $wishListProductsIds);
        $data['in_cart'] = in_array($product_info['product_id'], $cartlistIds);
        $data['max'] = $data['quantity'] - $quantityInCart;
